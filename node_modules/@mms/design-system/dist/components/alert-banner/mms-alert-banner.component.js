 ...
 *
 * @prop {AlertBannerType} alertType - Visual/semantic type: informational, error, success, caution
...
let MmsAlertBanner = class MmsAlertBanner extends LitElement {
    constructor() {
        ...
        this._handleActionClick = () => {
            this.dispatchEvent(new CustomEvent('action-click', { bubbles: true, composed: true, detail: { href: this.actionHref } }));
        };
...
MmsAlertBanner.styles = [
    ...
    css `
      ...
      /* Compact corner radius below the tablet breakpoint — media queries can't
         resolve custom properties, so the literal breakpoint value is unavoidable */
