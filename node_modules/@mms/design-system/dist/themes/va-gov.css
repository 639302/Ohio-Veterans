...
[data-theme="va-gov"] {
  ...
  /* Primary palette — Tier 1 (Full Component)
     Anchor #0071BB vs white: 5.15:1 — all constraints pass */
  --color-primary-1: #F4FBFF;
  --color-primary-2: #EBF5FF;
  --color-primary-3: #DDEDFE;
  --color-primary-4: #CFE6FD;
  --color-primary-5: #BFDDFA;
  --color-primary-6: #A3C9EC;
  --color-primary-7: #4A90C8;
  --color-primary-8: #2578B0;
  --color-primary-9: #0071BB;
  --color-primary-10: #00599D;
  --color-primary-11: #16598D;
  --color-primary-12: #002F56;

  /* Secondary palette — Tier 3 (Decorative)
     Anchor #A88B2D vs white: 3.28:1 — fails 4.5:1
     Steps 3-8, 10-12 intentionally omitted — decorative use only */
  --color-secondary-1: #FCFAF3;
  --color-secondary-2: #F7F3E9;
  --color-secondary-9: #A88B2D;

  /* Accent palette — Tier 2 (Text + Surface)
     Anchor #008577 vs white: 4.54:1 — passes
     Steps 3-8, 10 omitted — border contrast not achievable with visual distinction
     (Total luminance gap 7→9: 0.026 — insufficient for distinct steps) */
  --color-accent-1: #F5FCFA;
  --color-accent-2: #EBF6F4;
  --color-accent-9: #008577;
  --color-accent-11: #136358;
  --color-accent-12: #003730;
