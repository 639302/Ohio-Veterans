/* Theme: uss-oh-dvs (light mode) */
/* Ohio Department of Veterans Services */
/* Source: Ohio Brand Guide v1.9 + OHDOV_STYLE_GUIDE.md */
[data-theme="uss-oh-dvs"] {
  --color-neutral-1: var(--neutral-light-1);
  --color-neutral-2: var(--neutral-light-2);
  --color-neutral-3: var(--neutral-light-3);
  --color-neutral-4: var(--neutral-light-4);
  --color-neutral-5: var(--neutral-light-5);
  --color-neutral-6: var(--neutral-light-6);
  --color-neutral-7: var(--neutral-light-7);
  --color-neutral-8: var(--neutral-light-8);
  --color-neutral-9: var(--neutral-light-9);
  --color-neutral-10: var(--neutral-light-10);
  --color-neutral-11: var(--neutral-light-11);
  --color-neutral-12: var(--neutral-light-12);
  --color-neutral-placeholder: var(--neutral-light-placeholder);

  --color-onyx-1: var(--onyx-light-1);
  --color-onyx-2: var(--onyx-light-2);
  --color-onyx-3: var(--onyx-light-3);
  --color-onyx-4: var(--onyx-light-4);
  --color-onyx-5: var(--onyx-light-5);
  --color-onyx-6: var(--onyx-light-6);
  --color-onyx-7: var(--onyx-light-7);
  --color-onyx-8: var(--onyx-light-8);
  --color-onyx-9: var(--onyx-light-9);
  --color-onyx-10: var(--onyx-light-10);
  --color-onyx-11: var(--onyx-light-11);
  --color-onyx-12: var(--onyx-light-12);
  --color-text-on-onyx: #ffffff;

  /* Primary palette — Tier 1 (Full Component)
     Anchor #0E3F75 (Buckeye Blue) vs white: 10.57:1 — all constraints pass
     Steps 7-8 contrast-adjusted: 3.41:1 and 5.09:1 vs page (#fcfcfc)
     Luminance gaps: 7->8: 0.100, 8->9: 0.102 (both >= 0.03) */
  --color-primary-1: #f6fbff;
  --color-primary-2: #eef4fc;
  --color-primary-3: #e2ecfa;
  --color-primary-4: #d6e4f7;
  --color-primary-5: #c9dbf2;
  --color-primary-6: #aec4e1;
  --color-primary-7: #6E8CAC;
  --color-primary-8: #4A6F98;
  --color-primary-9: #0e3f75;
  --color-primary-10: #00295b;
  --color-primary-11: #001b40;
  --color-primary-12: #000a25;

  /* Secondary palette — Tier 1 (Full Component)
     Anchor #8A5E32 (Earth Brown) vs white: 5.63:1 — all constraints pass
     Steps 7-8 contrast-adjusted: 3.26:1 and 3.76:1 vs page (#fcfcfc)
     Luminance gaps: 7->8: 0.042, 8->9: 0.086 (both >= 0.03) */
  --color-secondary-1: #fdf9f6;
  --color-secondary-2: #f8f2ed;
  --color-secondary-3: #f3e9e0;
  --color-secondary-4: #eee0d3;
  --color-secondary-5: #e8d5c5;
  --color-secondary-6: #d4bdaa;
  --color-secondary-7: #A2886E;
  --color-secondary-8: #9F7B57;
  --color-secondary-9: #8a5e32;
  --color-secondary-10: #70481e;
  --color-secondary-11: #593b1c;
  --color-secondary-12: #3f2811;

  /* Accent palette — Tier 2 (Text + Surface)
     Anchor #C12637 (Cardinal Red) vs white: 5.83:1
     Steps 3-8, 10 omitted — Tier 2 (border steps not achievable)
     Ohio Brand Guide: Cardinal Red at full strength only; no tints as fills */
  --color-accent-1: #fff6f6;
  --color-accent-2: #ffeeed;
  --color-accent-9: #c12637;
  --color-accent-11: #801320;
  --color-accent-12: #5a0612;
