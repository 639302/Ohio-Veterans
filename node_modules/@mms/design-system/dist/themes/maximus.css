...
[data-theme="maximus"] {
  ...
  /* Primary palette — Tier 1 (Full Component)
     Anchor #502E91 vs white: 9.81:1 — all constraints pass */
  --color-primary-1: #FAF9FF;
  --color-primary-2: #F4F1FF;
  --color-primary-3: #ECE8FE;
  --color-primary-4: #E4DEFE;
  --color-primary-5: #DBD3FB;
  --color-primary-6: #C4BAEB;
  --color-primary-7: #8A7CC4;
  --color-primary-8: #6B5AAD;
  --color-primary-9: #502E91;
  --color-primary-10: #3B1774;
  --color-primary-11: #2A1055;
  --color-primary-12: #170236;

  /* Secondary palette — Tier 1 (Full Component)
     Anchor #6C489C vs white: 6.90:1 — all constraints pass */
  --color-secondary-1: #FBF9FF;
  --color-secondary-2: #F5F1FD;
  --color-secondary-3: #EEE7FB;
  --color-secondary-4: #E7DEF8;
  --color-secondary-5: #DED2F4;
  --color-secondary-6: #C8BAE3;
  --color-secondary-7: #8B7EB5;
  --color-secondary-8: #7068A0;
  --color-secondary-9: #6C489C;
  --color-secondary-10: #553380;
  --color-secondary-11: #422963;
  --color-secondary-12: #2C1844;

  /* Accent palette — Tier 3 (Decorative)
     Anchor #7EBE63 vs white: 2.23:1 — fails 4.5:1
     Steps 3-8, 10-12 intentionally omitted — decorative use only */
  --color-accent-1: #F7FCF5;
  --color-accent-2: #EEF6EB;
  --color-accent-9: #7EBE63;
