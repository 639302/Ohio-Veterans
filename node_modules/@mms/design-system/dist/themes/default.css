...
[data-theme="default"] {
  ...
  --color-primary-1: #fcfcfc;
  --color-primary-2: #f9f9f9;
  --color-primary-3: #f0f0f0;
  --color-primary-4: #e8e8e8;
  --color-primary-5: #e0e0e0;
  --color-primary-6: #d0d0d0;
  --color-primary-7: #b4b4b4;
  --color-primary-8: #8d8d8d;
  --color-primary-9: #6f6f6f;
  --color-primary-10: #5c5c5c;
  --color-primary-11: #484848;
  --color-primary-12: #1a1a1a;

  --color-secondary-1: #fcfcfc;
  --color-secondary-2: #f9f9f9;
  --color-secondary-3: #f0f0f0;
  --color-secondary-4: #e8e8e8;
  --color-secondary-5: #e0e0e0;
  --color-secondary-6: #d0d0d0;
  --color-secondary-7: #b4b4b4;
  --color-secondary-8: #8d8d8d;
  --color-secondary-9: #6f6f6f;
  --color-secondary-10: #5c5c5c;
  --color-secondary-11: #484848;
  --color-secondary-12: #1a1a1a;

  --color-accent-1: #fcfcfc;
  --color-accent-2: #f9f9f9;
  --color-accent-3: #f0f0f0;
  --color-accent-4: #e8e8e8;
  --color-accent-5: #e0e0e0;
  --color-accent-6: #d0d0d0;
  --color-accent-7: #b4b4b4;
  --color-accent-8: #8d8d8d;
  --color-accent-9: #6f6f6f;
  --color-accent-10: #5c5c5c;
  --color-accent-11: #484848;
  --color-accent-12: #1a1a1a;
