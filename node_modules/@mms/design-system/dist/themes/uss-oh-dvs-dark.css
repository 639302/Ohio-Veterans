/* Theme: uss-oh-dvs (dark mode) */
/* Ohio Department of Veterans Services */
/* Source: Ohio Brand Guide v1.9 + OHDOV_STYLE_GUIDE.md */
[data-theme="uss-oh-dvs"][data-mode="dark"] {
  --color-neutral-1: var(--neutral-dark-1);
  --color-neutral-2: var(--neutral-dark-2);
  --color-neutral-3: var(--neutral-dark-3);
  --color-neutral-4: var(--neutral-dark-4);
  --color-neutral-5: var(--neutral-dark-5);
  --color-neutral-6: var(--neutral-dark-6);
  --color-neutral-7: var(--neutral-dark-7);
  --color-neutral-8: var(--neutral-dark-8);
  --color-neutral-9: var(--neutral-dark-9);
  --color-neutral-10: var(--neutral-dark-10);
  --color-neutral-11: var(--neutral-dark-11);
  --color-neutral-12: var(--neutral-dark-12);
  --color-neutral-placeholder: var(--neutral-dark-placeholder);

  --color-onyx-1: var(--onyx-dark-1);
  --color-onyx-2: var(--onyx-dark-2);
  --color-onyx-3: var(--onyx-dark-3);
  --color-onyx-4: var(--onyx-dark-4);
  --color-onyx-5: var(--onyx-dark-5);
  --color-onyx-6: var(--onyx-dark-6);
  --color-onyx-7: var(--onyx-dark-7);
  --color-onyx-8: var(--onyx-dark-8);
  --color-onyx-9: var(--onyx-dark-9);
  --color-onyx-10: var(--onyx-dark-10);
  --color-onyx-11: var(--onyx-dark-11);
  --color-onyx-12: var(--onyx-dark-12);
  --color-text-on-onyx: #0a0c0e;

  /* Primary palette — Tier 1 (Full Component)
     Dark anchor #4e7eb9 (Buckeye Blue) vs dark bg (#060606): 4.83:1 — WCAG AA */
  --color-primary-1: #03060c;
  --color-primary-2: #0f151d;
  --color-primary-3: #0f1a27;
  --color-primary-4: #0f1e30;
  --color-primary-5: #15273e;
  --color-primary-6: #1a314e;
  --color-primary-7: #284465;
  --color-primary-8: #33547d;
  --color-primary-9: #4e7eb9;
  --color-primary-10: #6896d0;
  --color-primary-11: #a0c6f5;
  --color-primary-12: #c7e6ff;

  /* Secondary palette — Tier 1 (Full Component)
     Dark anchor #a17448 (Earth Brown) vs dark bg (#060606): 4.93:1 — WCAG AA */
  --color-secondary-1: #090502;
  --color-secondary-2: #1a140e;
  --color-secondary-3: #21170e;
  --color-secondary-4: #281a0c;
  --color-secondary-5: #342212;
  --color-secondary-6: #412b16;
  --color-secondary-7: #563c23;
  --color-secondary-8: #6a4b2d;
  --color-secondary-9: #a17448;
  --color-secondary-10: #b98d63;
  --color-secondary-11: #e3be9c;
  --color-secondary-12: #fddec3;

  /* Accent palette — Tier 2 (Text + Surface)
     Dark anchor #de454e (Cardinal Red) vs dark bg (#060606): 4.89:1 — WCAG AA
     Steps 3-8, 10 omitted — Tier 2 */
  --color-accent-1: #100202;
  --color-accent-2: #220e0e;
  --color-accent-9: #de454e;
  --color-accent-11: #ffa3a1;
  --color-accent-12: #ffc6c3;

  --color-text-on-primary: var(--near-black);
  --color-text-on-secondary: var(--near-black);
  --color-text-on-accent: var(--near-black);

  /* Typography: Ohio Brand Guide v1.9 — Source Sans 3 (primary typeface, all headlines/body).
     No brand monospace specified; tabular falls back to system stack. */
  --font-family-heading: 'Source Sans 3', system-ui, -apple-system, sans-serif;
  --font-family-body: 'Source Sans 3', system-ui, -apple-system, sans-serif;
  --font-family-tabular: ui-monospace, 'SF Mono', Menlo, Consolas, monospace;
  ...
  --color-action-text: var(--color-primary-9); /** Brand text for secondary/ghost buttons — uses brand primary */
  --color-action-text-hover: var(--color-primary-10); /** Hover state for brand text */
  ...
  --color-text-on-emphasis: #ffffff; /** Text on solid colored backgrounds (step 9) */
  ...
  --color-surface-raised: var(--color-neutral-1); /** Elevated surfaces (modals, dropdowns) — Marina parity: --global-surface-default equals --global-surface-background in every dark theme (both color-neutral-black); dark-mode elevation is conveyed by the shadow/hairline stroke below, not by lightening the surface */
  --color-surface-sunken: var(--color-neutral-3); /** Inset areas, code blocks, input backgrounds */
  ...
  --color-overlay-scrim: rgba(77, 77, 77, 0.7); /** Marina parity: dark-mode scrim lightens to a mid-gray (--color-utility-overlay-scrim-inverse) instead of staying near-black — the light-mode near-black scrim is nearly invisible against an already near-black dark-mode page */
  ...
  --color-utility-informational-stroke: var(--color-neutral-6); /** Informational border */
  --color-utility-informational-text: var(--color-neutral-11); /** Informational text/icons — meets 4.5:1 on neutral surfaces */

  /* Elevation — Marina parity: dark mode keeps the same black shadow blurs as light mode
     and adds a third zero-blur box-shadow layer as a light neutral hairline stroke, since
     the black shadow alone doesn't read against a dark surface/backdrop */
  --elevation-sm: 0 1px 3px 1px rgba(0,0,0,0.15), 0 1px 2px 0 rgba(0,0,0,0.30), 0 0 0 1px rgba(179,179,179,0.40);
  --elevation-md: 0 2px 6px 2px rgba(0,0,0,0.15), 0 1px 2px 0 rgba(0,0,0,0.30), 0 0 0 1px rgba(179,179,179,0.50);
  --elevation-lg: 0 4px 8px 3px rgba(0,0,0,0.15), 0 1px 3px 0 rgba(0,0,0,0.30), 0 0 0 1px rgba(242,242,242,0.40);
  --elevation-xl: 0 6px 10px 4px rgba(0,0,0,0.15), 0 2px 3px 0 rgba(0,0,0,0.30), 0 0 0 1px rgba(242,242,242,0.55);
  ...
  --type-ui-label-family: var(--font-family-body);
  --type-ui-label-size: var(--text-ui-label-size);
  --type-ui-label-line-height: var(--text-ui-label-line-height);
  --type-ui-label-letter-spacing: var(--text-ui-label-letter-spacing);
  --type-ui-label-weight: var(--font-weight-medium);
