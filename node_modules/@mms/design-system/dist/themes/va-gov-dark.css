/* Theme: va-gov (dark mode) */
[data-theme="va-gov"][data-mode="dark"] {
  ...
  --color-primary-1: #04060a;
  --color-primary-2: #11151b;
  --color-primary-3: #131a23;
  --color-primary-4: #141e2a;
  --color-primary-5: #1b2737;
  --color-primary-6: #223145;
  --color-primary-7: #32445b;
  --color-primary-8: #3e5470;
  --color-primary-9: #5e7ea7;
  --color-primary-10: #7796be;
  --color-primary-11: #abc5e6;
  --color-primary-12: #d0e5ff;

  /* Secondary palette — Tier 3 (Decorative)
     Anchor fails 4.5:1 vs white in light mode
     Steps 3-8 intentionally omitted — decorative use only */
  --color-secondary-1: #080501;
  --color-secondary-2: #18150a;
  --color-secondary-9: #806400;

  /* Accent palette — Tier 2 (Text + Surface)
     Anchor passes 4.5:1 but borders not achievable with visual distinction
     Steps 3-8, 10 omitted */
  --color-accent-1: #010706;
  --color-accent-2: #0c1815;
  --color-accent-9: #138c7d;
  --color-accent-11: #88cfc3;
  --color-accent-12: #b4ede3;

  --color-text-on-primary: var(--near-black);
  --color-text-on-secondary: #1b1b1b;
  --color-text-on-accent: #ffffff;

  --font-family-heading: 'Source Sans Pro', system-ui, -apple-system, sans-serif;
  --font-family-body: 'Source Sans Pro', system-ui, -apple-system, sans-serif;
  --font-family-tabular: 'Roboto Mono', ui-monospace, 'SF Mono', Menlo, Consolas, monospace;
