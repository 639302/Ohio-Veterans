/* Theme: maximus (dark mode) */
[data-theme="maximus"][data-mode="dark"] {
  ...
  --color-primary-1: #06040f;
  --color-primary-2: #161220;
  --color-primary-3: #1b152c;
  --color-primary-4: #1f1636;
  --color-primary-5: #291e45;
  --color-primary-6: #342557;
  --color-primary-7: #463670;
  --color-primary-8: #57438b;
  --color-primary-9: #876ad2;
  --color-primary-10: #9e84e9;
  --color-primary-11: #cbb9ff;
  --color-primary-12: #e7d9ff;

  /* Secondary palette — Tier 1 (Full Component) */
  --color-secondary-1: #07040d;
  --color-secondary-2: #17121e;
  --color-secondary-3: #1d1528;
  --color-secondary-4: #211631;
  --color-secondary-5: #2c1e3f;
  --color-secondary-6: #372650;
  --color-secondary-7: #4a3668;
  --color-secondary-8: #5c4480;
  --color-secondary-9: #8f6bc2;
  --color-secondary-10: #a685da;
  --color-secondary-11: #d2b8fe;
  --color-secondary-12: #eed9ff;

  /* Accent palette — Tier 3 (Decorative)
     Anchor fails 4.5:1 vs white in light mode
     Steps 3-8 intentionally omitted — decorative use only */
  --color-accent-1: #030702;
  --color-accent-2: #0f180c;
  --color-accent-9: #1c5a00;

  --color-text-on-primary: var(--near-black);
  --color-text-on-secondary: var(--near-black);
  --color-text-on-accent: #1e3f17;

  --font-family-heading: 'Avenir Next LT Pro', system-ui, -apple-system, 'Segoe UI', sans-serif;
  --font-family-body: 'Avenir Next LT Pro', system-ui, -apple-system, 'Segoe UI', sans-serif;
