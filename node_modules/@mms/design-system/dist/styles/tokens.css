...
:root {
  --neutral-light-1: #fcfcfc;
  --neutral-light-2: #f9f9f9;
  --neutral-light-3: #f0f0f0;
  --neutral-light-4: #e8e8e8;
  --neutral-light-5: #e0e0e0;
  --neutral-light-6: #b8b8b8;
  --neutral-light-7: #878787;
  --neutral-light-8: #737373;
  --neutral-light-9: #606060;
  --neutral-light-10: #484848;
  --neutral-light-11: #303030;
  --neutral-light-12: #1a1a1a;
  --neutral-light-placeholder: #6d6d6d; /* Passes 4.5:1 on surface-sunken (#f0f0f0) */
  --neutral-dark-1: #060606;
  --neutral-dark-2: #151515;
  --neutral-dark-3: #191919;
  --neutral-dark-4: #1d1d1d;
  --neutral-dark-5: #262626;
  --neutral-dark-6: #444444;
  --neutral-dark-7: #636363;
  --neutral-dark-8: #7d7d7d;
  --neutral-dark-9: #979797;
  --neutral-dark-10: #b0b0b0;
  --neutral-dark-11: #cacaca;
  --neutral-dark-12: #e3e3e3;
  --neutral-dark-placeholder: #8c8c8c; /* Passes 4.5:1 on pressed (#262626) */
  --white: #ffffff;
  --near-black: #0a0c0e;
  --onyx-light-1: #f8f9fb;
  --onyx-light-2: #f2f4f7;
  ...
  --onyx-light-8: #4d5766;
  --onyx-light-9: #1f252d;
  --onyx-light-10: #161a21;
  --onyx-light-11: #0f1216;
  --onyx-light-12: #080a0c;
  --onyx-dark-1: #080a0c;
  --onyx-dark-2: #0f1216;
  --onyx-dark-3: #161a21;
  --onyx-dark-4: #1f252d;
...
:root {
  ...
  --layout-inline-padding-default: 24px; /** Horizontal padding inside the content container at the padding step and above. Aliases --spacing-lg1. */
  ...
  --text-ui-label-lg-size: 1rem; /** 16px — Accessibility-first labels, government default */
  --text-ui-label-lg-line-height: 1.4;
  --text-ui-label-lg-letter-spacing: 0.01em;
  --text-ui-label-size: 0.875rem; /** 14px — Standard UI density labels */
  --text-ui-label-line-height: 1.4;
  --text-ui-label-letter-spacing: 0.01em;
...
[data-mode="dark"] {
  ...
  /* On-fill indicators swap to dark variants for contrast on light fills */
  --color-utility-error-on-fill: #aa010e;
  --color-utility-success-on-fill: #0e580e;
  --color-utility-caution-on-fill: #936f38;
}
